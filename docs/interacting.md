...
how simple it is on
[../examples/bash_client/client.sh](https://github.com/marcohextor/boast/blob/master/examples/bash_client/client.sh).
...
server's
[configured](https://github.com/marcohextor/boast/blob/master/docs/boast-configuration.md)
